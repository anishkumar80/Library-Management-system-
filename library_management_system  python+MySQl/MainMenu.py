...
def Adminmenu():
    while True:
        print("-----------------THE ANISH MEMORIAL LIBRARY-------------------- ")
        print("\t\t_____Admin Menu____")
        print("==============================================================")
...
p = input("Enter(Admin / User) Whoever you are:")
if(p=="Admin" or p=="admin" or p=="ADMIN"):
    Adminmenu()
elif(p=='User' or p=='user' or p=='USER'):
    Usermenu()
else:
