...
if result : 
    ...
    mycursor.execute("""CREATE TABLE BookRecord(BookID varchar(15) PRIMARY KEY , BookName varchar(35),
...
if result : 
    ...
    mycursor.execute("""CREATE TABLE UserRecord(UserID varchar(12) PRIMARY KEY, UserName varchar(20),
                            Password varchar(20), Branch varchar(30), BookID varchar(10),
